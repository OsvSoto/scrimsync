...
<div class="min-h-screen bg-background flex pt-16">
    ...
    <main class="w-full md:ml-64 p-8">
        ...
        <div class="flex justify-between items-end mb-10">
            ...
            <a href="form.php" class="bg-primary text-white px-6 py-3 font-bold text-sm uppercase tracking-widest hover:bg-zinc-800 transition-colors flex items-center gap-2">
