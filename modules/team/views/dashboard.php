<div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8">
    <div>
      <h2 class="text-2xl sm:text-3xl font-black text-primary uppercase tracking-tight">Mis Equipos</h2>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <?php foreach ($mis_equipos as $equipo): ?>
      ...
      <a href="../profile/view.php?id=<?php echo $equipo['equ_id']; ?>" class="bg-surface border-2 border-primary shadow-hard  transition-all group flex flex-col h-full block">
