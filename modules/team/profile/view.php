...
$sql_miembros = "SELECT u.usu_username, u.usu_alias, pe.*, r.rol_nombre, u.usu_foto
      ...
      <div class="bg-surface border-2 border-primary overflow-hidden shadow-hard">
        <div class="h-32 sm:h-48 bg-primary relative">
          <?php if ($equipo['equ_logo']): ?>
            <div class="absolute inset-0 opacity-75" style="background-image: url('<?php echo "../../../" . $equipo['equ_logo']; ?>'); background-size: 100px 100px; background-repeat-round: repeat;"></div>
          <?php else: ?>
        ...
        <div class="px-2 pb-6 sm:px-7 relative">
          <div class="flex flex-col sm:flex-row items-center sm:items-end -mt-12 mb-6 gap-6">
            <div class="w-32 h-32 border-4 border-surface bg-surface shadow-lg overflow-hidden flex-shrink-0">
              <?php if ($equipo['equ_logo']): ?>
        ...
        <div class="grid grid-cols-1 gap-2">
          ...
          ?>
              <div class="bg-surface p-3 border-2 border-primary flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 shadow-hard-sm">
                ...
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 bg-subtle border-2 border-border flex items-center justify-center text-muted flex-shrink-0">
                  ...
                  <div>
                    <div class="flex items-center gap-2">
                      <h4 class="font-black text-primary uppercase tracking-tight text-sm">
            ...
            <div class="bg-subtle p-4 border border-border">
              ...
              <form action="../availability/controller_availability.php" method="POST" class="grid grid-cols-1 md:grid-cols-7 gap-2 items-end">
                ...
                <div class="md:col-span-7 mt-2">
                  <button type="submit" class="btn btn-xs rounded-none text-xs text-surface font-black uppercase tracking-widest bg-primary hover:bg-primary-hover w-full">
